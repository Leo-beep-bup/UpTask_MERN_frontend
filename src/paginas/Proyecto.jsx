...
import Colabrador from '../components/Colabrador'
        ...
        <div className='flex justify-between'>
          ...
          {admin && (
              <button
                ...
                type='button'
                className='text-sm px-5 py-3 w-full md:w-auto rounded-lg uppercase bg-sky-400 text-center items-center text-white mt-5 flex gap-2'
              >
