...
const ModalFormularioTarea = () => {
    ...
    return (
        <Transition.Root show={ modalFormularioTarea } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={ () => handleModalTarea(false) }>
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button
                                    ...
                                    onClick={ () => handleModalTarea(false) }
                                >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form 
                                        ...
                                        <input 
                                            type="submit"
                                            className='w-full bg-sky-600 hover:bg-sky-700 p-3 text-white uppercase font-bold cursor-pointer transition-colors rounded text-sm'
